...
def main():
    ...
    print("Columns: R_an/dx = analyticity radius in cells; scale/r-scl = scale used;")
    print("  delta = WORST 1D sparseness p95 over the six sets {omega_i+/- > lam sup},")
    print("          lam = 1/2, evaluated at r ~ that scale -- the Thm C3 hypothesis;")
    print("  set = which of the six component sets was worst;")
